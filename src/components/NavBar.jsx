...
function NavBar() {
  return (
    <div className='fixed top-0 w-full '>
        <div className='bg-slate-900 flex items-center gap-3 justify-center m-auto py-2.5'>
        ...
        <nav className='bg-white shadow-lg flex justify-between items-center px-7 py-3'>
